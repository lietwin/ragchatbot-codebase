...
class TestAIGenerator:
    ...
    def test_system_prompt_content(self):
        ...
        with patch('anthropic.Anthropic'):
            ...
            assert "two sequential tool calling rounds per query" in generator.SYSTEM_PROMPT
    ...
    def test_two_round_tool_sequence(self, mock_anthropic_client_two_rounds):
        ...
        with patch('anthropic.Anthropic', return_value=mock_anthropic_client_two_rounds):
            generator = AIGenerator("test-key", "test-model")
            ...
            tool_manager.execute_tool.assert_any_call("get_course_outline", course_title="MCP")
            tool_manager.execute_tool.assert_any_call("search_course_content", query="MCP fundamentals")
    ...
    def test_single_round_termination(self, mock_anthropic_client_terminating):
        ...
        with patch('anthropic.Anthropic', return_value=mock_anthropic_client_terminating):
            generator = AIGenerator("test-key", "test-model")
    ...
    def test_max_rounds_termination(self, mock_anthropic_client_two_rounds):
        ...
        with patch('anthropic.Anthropic', return_value=mock_anthropic_client_two_rounds):
            ...
            final_call_args = mock_anthropic_client_two_rounds.messages.create.call_args_list[2][1]

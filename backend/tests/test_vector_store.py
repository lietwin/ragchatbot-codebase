...
class TestVectorStore:
    ...
    def test_search_with_course_name_filter(self):
        ...
        with patch('chromadb.PersistentClient') as mock_client, \
            ...
            mock_client.return_value.get_or_create_collection.side_effect = mock_get_collection
            ...
            mock_content_collection.query.return_value = {
                ...
                'metadatas': [[{'course_title': 'MCP: Build Rich-Context AI Apps', 'lesson_number': 1}]],
                'distances': [[0.1]]
            }
    ...
    def test_search_with_both_filters(self):
        ...
        with patch('chromadb.PersistentClient') as mock_client, \
            ...
            mock_content_collection.query.return_value = {
                ...
                'metadatas': [[{'course_title': 'Resolved Course Title', 'lesson_number': 3}]],
                'distances': [[0.1]]
            }
    ...
    def test_search_with_custom_limit(self):
        ...
        with patch('chromadb.PersistentClient') as mock_client, \
            ...
            mock_collection.query.return_value = {
                ...
                'metadatas': [[{'course_title': 'Course', 'lesson_number': 1}, 
    ...
    def test_resolve_course_name_with_exception(self):
        ...
        with patch('chromadb.PersistentClient') as mock_client, \
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_called_once_with("Error resolving course name: Query failed")
                assert result is None
